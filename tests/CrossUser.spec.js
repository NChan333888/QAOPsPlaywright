...
const YAHOO_USER = { email: 'abcefg@yopmail.com', password: 'Abcefg123$$$' };
const GMAIL_USER = { email: 'abcefg2@yopmail.com', password: 'Abcefg123$$$' };
...
test.skip('gmail user sees Access Denied when viewing yahoo user booking', async ({ page, request }) => {
